...
///
/// This is the batch preset apply primitive. Unlike [`sync_single_skill_to_tool`]
/// (which carries the implicit active-preset toggle side-effect), this batch is a pure
